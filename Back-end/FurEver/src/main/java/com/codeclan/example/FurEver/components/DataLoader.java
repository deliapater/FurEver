...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Dog dog1 = new Dog("Fido", "Affenpinscher", "Male", 4, "https://s3.amazonaws.com/cdn-origin-etr.akc.org/wp-content/uploads/2017/11/30174107/Affenpinscher-copy.jpg", "I am Fido, I am a four year old Affenpinscher from Austria", owner1);
        dogRepository.save(dog1);
        Dog dog2 = new Dog("Wido", "Alaskan Klee Kai", "Female", 5, "https://embarkvet.com/wp-content/uploads/2018/08/alaskan-klee-kai-5.jpg", "I am Wido, I am a five year old Alaskan KleeKai from Alaska", owner1);
        dogRepository.save(dog2);
        Dog dog3 = new Dog("Kloe", "Afghan Hound", "Female", 2, "https://vetstreet.brightspotcdn.com/dims4/default/869e315/2147483647/thumbnail/645x380/quality/90/?url=https%3A%2F%2Fvetstreet-brightspot.s3.amazonaws.com%2Ff3%2F88ed60a3ff11e087a80050568d634f%2Ffile%2FAfghan-Hound-3-645mk-062311.jpg", "I am Kloe, I am a two year old Afghan Hound from Afghanistan", owner3);
        dogRepository.save(dog3);
        Dog dog4 = new Dog("Napo", "Daschund", "Male", 12, "https://dachshund-central.com/wp-content/uploads/2018/02/dachshund-dog-4.jpg", "I am looking for true love", owner2);
        dogRepository.save(dog4);
        Dog dog5 = new Dog("Woofer", "Ladrador", "Male", 3, "https://timedotcom.files.wordpress.com/2017/03/labrador.jpg?quality=85", "Woof", owner3);
        dogRepository.save(dog5);
        Dog dog6 = new Dog("Susy", "Chihuaha", "Female", 5, "https://www.dogbreedinfo.com/images15/ChihuahuaDaisyphlox0416.JPG", "I am beautiful Chihuahua looking for woof", owner4);
        dogRepository.save(dog6);
        Dog dog7 = new Dog("Hachiko", "Akita", "Male", 8, "https://en.mthai.com/app/uploads/2015/04/Cr.-imgarcade.jpg", "Hiya", owner5);
        dogRepository.save(dog7);
        Dog dog8 = new Dog("Ozzy", "American Bulldog", "Male", 1, "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/American_bulldog.jpg/220px-American_bulldog.jpg", "Looking to make some friends!", owner6);
        dogRepository.save(dog8);
        Dog dog9 = new Dog("Scooby", "Border Terrier", "Male", 9, "https://cdn1-www.dogtime.com/assets/uploads/gallery/border-terrier-dog-breed-pictures/8-face.jpg", "Hi all!", owner6);
        dogRepository.save(dog9);
        Dog dog10 = new Dog("Lucky", "Chihuaha", "Male", 3, "https://g77v3827gg2notadhhw9pew7-wpengine.netdna-ssl.com/wp-content/uploads/2017/08/dog-1878459_1920-1-1024x682.jpg", "Hello! I am a nice little gentleman", owner6);
